...
const baseURL = 'poll-service-production-br.pythian-int.com'
        ...
        legs: [
            {
                origin: {
                    type: "city",
                    id: csvData[scenario.iterationInTest].origin_city_id
                },
                destination: {
                    type: "city",
                    id: csvData[scenario.iterationInTest].destination_city_id
                },
                date: date
            }
        ],
